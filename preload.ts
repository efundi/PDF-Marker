...
contextBridge.exposeInMainWorld('assignmentApi', {
  ...
  finalizeAssignmentRubric: (workspaceFolder: string, location: string, rubricName: string, zipFilePath: string) => ipcRenderer.invoke('assignments:finalizeAssignmentRubric', workspaceFolder, location, rubricName, zipFilePath),
