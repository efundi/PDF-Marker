...
contextBridge.exposeInMainWorld('assignmentApi', {
  ...
  saveMarks: (workspaceName: string, assignmentName: string, marks: any[], totalMarks: any) => ipcRenderer.invoke('assignments:saveMarks', workspaceName, assignmentName, marks, totalMarks),
  saveRubricMarks: (workspaceFolder: string, assignmentName: string, rubricName: string, marks: any[]) => ipcRenderer.invoke('assignments:saveRubricMarks', workspaceFolder, assignmentName, rubricName, marks),
  ...
  getMarks: (workspaceFolder: string, location) => ipcRenderer.invoke('assignments:getMarks', location),
  getGrades: (workspaceFolder: string, assignmentName) => ipcRenderer.invoke('assignments:getGrades', workspaceFolder, assignmentName),
