...
/* harmony import */ var _src_shared_constants_constants__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../src/shared/constants/constants */ "./src/shared/constants/constants.ts");
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./constants */ "./src-electron/constants.ts");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./utils */ "./src-electron/utils.ts");
/**
 * ##################################################
 *
 ...
 */
function getConfig() {
    return (0,fs_promises__WEBPACK_IMPORTED_MODULE_3__.readFile)(_constants__WEBPACK_IMPORTED_MODULE_8__.CONFIG_DIR + _constants__WEBPACK_IMPORTED_MODULE_8__.CONFIG_FILE).then((data) => {
        if (!(0,_utils__WEBPACK_IMPORTED_MODULE_9__.isJson)(data)) {
            return Promise.reject(`Corrupt configuration files at "${_constants__WEBPACK_IMPORTED_MODULE_8__.CONFIG_DIR}${_constants__WEBPACK_IMPORTED_MODULE_8__.CONFIG_FILE}"`);
        }
...
function getWorkingDirectoryAbsolutePath(workspaceName) {
    return getConfig().then((config) => {
        if (workspaceName === _src_shared_constants_constants__WEBPACK_IMPORTED_MODULE_7__.DEFAULT_WORKSPACE || (0,lodash__WEBPACK_IMPORTED_MODULE_4__.isNil)(workspaceName)) {
...
function getAssignmentSettingsAt(assignmentFolder) {
    ...
    if ((0,fs__WEBPACK_IMPORTED_MODULE_1__.existsSync)(assignmentFolder)) {
        return (0,fs_promises__WEBPACK_IMPORTED_MODULE_3__.readFile)(assignmentFolder + path__WEBPACK_IMPORTED_MODULE_2__.sep + _src_shared_constants_constants__WEBPACK_IMPORTED_MODULE_7__.SETTING_FILE).then((data) => {
            if (!(0,_utils__WEBPACK_IMPORTED_MODULE_9__.isJson)(data)) {
...
function writeAssignmentSettingsAt(assignmentSettings, assignmentAbsolutePath) {
    ...
    return (0,_utils__WEBPACK_IMPORTED_MODULE_9__.writeToFile)(assignmentAbsolutePath + path__WEBPACK_IMPORTED_MODULE_2__.sep + _src_shared_constants_constants__WEBPACK_IMPORTED_MODULE_7__.SETTING_FILE, buffer, null, 'Failed to save assignment settings!').then(() => {
...
node_worker_threads__WEBPACK_IMPORTED_MODULE_0__.parentPort.on('message', (exportAssignmentsRequest) => {
    const tempDirectory = (0,fs__WEBPACK_IMPORTED_MODULE_1__.mkdtempSync)((0,path__WEBPACK_IMPORTED_MODULE_2__.join)((0,os__WEBPACK_IMPORTED_MODULE_6__.tmpdir)(), 'pdfm-'));
    ...
    return Promise.all([
        ...
        if (!(0,lodash__WEBPACK_IMPORTED_MODULE_4__.isNil)(exportAssignmentsRequest.studentIds)) {
            // If a list of student ids was supplied we'll filter only those
            exportSubmissions = (0,lodash__WEBPACK_IMPORTED_MODULE_4__.filter)(assignmentSettings.submissions, (submission) => {
        ...
        const promises = exportSubmissions.map((submission) => {
            return (0,fs_extra__WEBPACK_IMPORTED_MODULE_5__.copy)(originalAssignmentDirectory + path__WEBPACK_IMPORTED_MODULE_2__.sep + submission.directoryName, exportTempDirectory + path__WEBPACK_IMPORTED_MODULE_2__.sep + submission.directoryName, {
                recursive: true
            });
        });
        return Promise.all(promises)
            ...
            const exportSettings = (0,lodash__WEBPACK_IMPORTED_MODULE_4__.cloneDeep)(assignmentSettings);
            if (!(0,lodash__WEBPACK_IMPORTED_MODULE_4__.isNil)(exportAssignmentsRequest.studentIds)) {
