...
!macro customInstall
  ...
  ${If} $LibreInstallCheckbox_State == ${BST_CHECKED}
    ...
    NScurl::http get "https://downloadarchive.documentfoundation.org/libreoffice/old/7.6.2.1/win/x86_64/LibreOffice_7.6.2.1_Win_x86-64.msi" "$TEMP\LibreOffice_7.6.2.1_Win_x86-64.msi" /POPUP /INSIST /Zone.Identifier /END
    Pop $0
    ExecWait '"msiexec" /i "$TEMP\LibreOffice_7.6.2.1_Win_x86-64.msi" /passive'
  ${EndIf}
