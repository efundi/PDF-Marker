...
const routes: Routes = [
  ...
  { path: 'marker/assignment/overview', component: AssignmentOverviewComponent },
  { path: 'marker/assignment/overview/:workspaceName', component: AssignmentOverviewComponent },
  { path: 'marker/assignment/workspaceOverview', component: AssignmentWorkspaceOverviewComponent },
  { path: 'marker/assignment/workingFolder', component: WorkingFolderComponent },
  { path: 'marker/assignment/marking', component: AssignmentMarkingComponent },
