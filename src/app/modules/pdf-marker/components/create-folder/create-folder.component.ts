...
@Component({
  selector: 'pdf-marker-create-folder',
...
export class CreateFolderComponent implements OnInit, OnDestroy {
    ...
    this.activatedRoute.params.subscribe(params => {
      ...
      if(id && !!this.assignmentService.getSelectedAssignment()) {
        ...
        this.assignmentService.getAssignmentSettings(id).subscribe((assignmentSettings: AssignmentSettingsInfo) => {
          ...
          this.disableFields(this.createFolderForm, fields);
  ...
  onRubricChange() {
    ...
    this.createFolderForm.updateValueAndValidity();
  }
  ...
  onSubmit(event) {
    ...
    if(this.createFolderForm.invalid || this.studentRow.invalid) {
  ...
  private onEdit() {
    const formValue: any = this.createFolderForm.value;
